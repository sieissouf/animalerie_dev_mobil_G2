  ...
  <body>
        <div class="container">
            <div class="col-md-12">
                ...
                <div id="align-f">
                    <!-- <div class="text-left"> -->
                        <h5>Bonjour <?php echo $data['pseudo']; ?> !</h5>
                    <!-- </div>         -->
                            
                    <div class="text-btn">
                        <a href="deconnexion.php" class="btn btn-danger"><img src="image/dec.jpg" alt=""></a>
                        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#change_password"><img src="image/dec3.png" alt=""></button>
                    </div>        
                </div>    
            </div>
        </div>    
